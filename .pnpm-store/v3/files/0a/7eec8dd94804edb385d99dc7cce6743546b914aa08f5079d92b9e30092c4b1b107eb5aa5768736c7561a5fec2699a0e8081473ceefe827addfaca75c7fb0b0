...
export type BuildTool = "@arethetypeswrong/cli" | "typescript" | "rollup" | "@rollup/plugin-typescript" | "@rollup/plugin-typescript2" | "webpack" | "esbuild" | "parcel-bundler" | "@preconstruct/cli" | "vite" | "snowpack" | "microbundle" | "@microsoft/api-extractor" | "tshy" | "@rspack/cli" | "tsup";
...
export type Problem = NoResolutionProblem | UntypedResolutionProblem | FalseESMProblem | FalseCJSProblem | CJSResolvesToESMProblem | FallbackConditionProblem | FalseExportDefaultProblem | MissingExportEqualsProblem | InternalResolutionErrorProblem | UnexpectedModuleSyntaxProblem | CJSOnlyExportsDefaultProblem;
